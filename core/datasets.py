...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/hdd1/dataset/opticalflow/Sintel', dstype='clean',
...
class FlyingChairs(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/hdd1/dataset/opticalflow/FlyingChairs_release/data'):
        ...
        split_list = np.loadtxt('/hdd1/dataset/opticalflow/FlyingChairs_release/FlyingChairs_train_val.txt', dtype=np.int32)
...
class FlyingThings3D(FlowDataset):
    def __init__(self, aug_params=None, root='/hdd1/dataset/opticalflow/FlyingThings3D', split='training', dstype='frames_cleanpass'):
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/hdd1/dataset/opticalflow/KITTI'):
...
class HD1K(FlowDataset):
    def __init__(self, aug_params=None, root='/hdd1/dataset/opticalflow/HD1k'):
...
def fetch_dataloader(args, TRAIN_DS='C+T+K+S+H'):
    ...
    train_loader = data.DataLoader(train_dataset, batch_size=args.batch_size,
                                   pin_memory=False, shuffle=True, num_workers=6, drop_last=True, persistent_workers=True)
